/*
 * IDENTIFICATION:
 * stub generated Sun Oct  1 19:02:57 2017
...
#endif
	typedef __Request__host_statistics_t __Request;
	typedef __Reply__host_statistics_t Reply __attribute__((unused));
...
#endif
	typedef __Request__host_statistics64_t __Request;
	typedef __Reply__host_statistics64_t Reply __attribute__((unused));
	...
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	...
	if ((InHeadP->msgh_id > 230) || (InHeadP->msgh_id < 200) ||
