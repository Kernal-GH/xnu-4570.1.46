/*
 * IDENTIFICATION:
 * stub generated Sun Oct  1 19:03:01 2017
...
#pragma pack()
	...
	if (mig_strncpy_zerofill != NULL) {
		InP->executionPathCnt = mig_strncpy_zerofill(InP->executionPath, executionPath, 1024);
	} else {
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->bundlePathCnt = mig_strncpy_zerofill(InP->bundlePath, bundlePath, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->fileNameCnt = mig_strncpy_zerofill(InP->fileName, fileName, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->fileExtensionCnt = mig_strncpy_zerofill(InP->fileExtension, fileExtension, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->messageKeyCnt = mig_strncpy_zerofill(InP->messageKey, messageKey, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->fileNameCnt = mig_strncpy_zerofill(InP->fileName, fileName, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->fileExtensionCnt = mig_strncpy_zerofill(InP->fileExtension, fileExtension, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->tokenKeyCnt = mig_strncpy_zerofill(InP->tokenKey, tokenKey, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->iconPathCnt = mig_strncpy_zerofill(InP->iconPath, iconPath, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->soundPathCnt = mig_strncpy_zerofill(InP->soundPath, soundPath, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->localizationPathCnt = mig_strncpy_zerofill(InP->localizationPath, localizationPath, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->headerCnt = mig_strncpy_zerofill(InP->header, header, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->messageCnt = mig_strncpy_zerofill(InP->message, message, 1024);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->defaultButtonTitleCnt = mig_strncpy_zerofill(InP->defaultButtonTitle, defaultButtonTitle, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->alternateButtonTitleCnt = mig_strncpy_zerofill(InP->alternateButtonTitle, alternateButtonTitle, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
...
#ifdef USING_MIG_STRNCPY_ZEROFILL
	if (mig_strncpy_zerofill != NULL) {
		InP->otherButtonTitleCnt = mig_strncpy_zerofill(InP->otherButtonTitle, otherButtonTitle, 128);
	} else {
#endif /* USING_MIG_STRNCPY_ZEROFILL */
